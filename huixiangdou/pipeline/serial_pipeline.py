...
from ..primitive import Query, LLM
from ..service import SharedRetrieverPool, Retriever, WebRetriever, ErrorCode, is_truth
...
class SerialPipeline:
    ...
    def __init__(self, work_dir: str, config_path: str, language: str = 'zh'):
        ...
        self.retriever = SharedRetrieverPool(config_path=config_path).get()
