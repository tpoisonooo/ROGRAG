...
def test_chat_coref():
    ...
    request_body = {
        ...
        "history": [
            {
                "user": "蚕豆如何种植？",
                "assistant": "本发明提出了一种蚕豆的种植方法，包括选地及整地、选种及处理、播种、肥水管理、植株管理、病虫害防治、适时采收等步骤，通过前期合理施加混合基料和基肥，大大改善了土地的肥沃性，降低了板结度，配合后期科学合理的肥水管理显著提高了蚕豆的出苗率和生长速率，另外，对土地、种子及种植初期的杀菌处理，大大减轻了病虫害的发生率，采用本发明种植方法种植的蚕豆饱满度高、虫害率低，植株长势均匀，且相较于传统的蚕豆种植，亩产量提高了30％左右。",
                "references": []
            }
        ]
    }
