...
if __name__ == '__main__':
    if len(sys.argv) > 1:
        ...
        # path = '/data/khj/workspace/HuixiangDou/2025-01-08_16/2_hybrid_zero_shot_kag_seedllm_Qwen2.5-7B-Instruct.jsonl'
        path = '/data/khj/workspace/HuixiangDou/2025-01-10_15/2_hybrid_zero_shot_kag_seedllm_Qwen2.5-7B-Instruct.jsonl'
        path = '/data/khj/workspace/HuixiangDou/2025-01-10_19/2_hybrid_zero_shot_kag_seedllm_Qwen2.5-7B-Instruct.jsonl'
    calc(path=path)
